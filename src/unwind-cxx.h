...
extern "C" __cxa_eh_globals *__cxa_get_globals () noexcept(true);
extern "C" __cxa_eh_globals *__cxa_get_globals_fast () noexcept(true);

// Allocate memory for the primary exception plus the thrown object.
extern "C" void *__cxa_allocate_exception(std::size_t thrown_size) noexcept(true);
// Allocate memory for dependent exception.
extern "C" __cxa_dependent_exception *__cxa_allocate_dependent_exception() noexcept(true);

// Free the space allocated for the primary exception.
extern "C" void __cxa_free_exception(void *thrown_exception) noexcept(true);
// Free the space allocated for the dependent exception.
extern "C" void __cxa_free_dependent_exception(__cxa_dependent_exception *dependent_exception) noexcept(true);
...
extern "C" void *__cxa_begin_catch (void *) noexcept(true);
