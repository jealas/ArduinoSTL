...
namespace std{
	...
	_UCXXEXPORT logic_error::logic_error() noexcept(true) : mstring(){
	...
	_UCXXEXPORT const char * logic_error::what() const noexcept(true){
	...
	_UCXXEXPORT const char * runtime_error::what() const noexcept(true){
		return mstring.c_str();
	}
