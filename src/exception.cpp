...
namespace std{
	...
	_UCXXEXPORT exception::~exception() noexcept(true){
		//Empty function
	}

	_UCXXEXPORT const char* exception::what() const noexcept(true){
		return __std_exception_what_value;
	}

	_UCXXEXPORT bad_exception::~bad_exception() noexcept(true){
